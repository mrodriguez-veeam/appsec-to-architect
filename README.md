...
| 04 | [Resource-level authorization (IDOR/BOLA)](projects/04-resource-level-authorization/) | Per-object ownership checks: stops a valid user reading others' records (OWASP API1) | 🟢 Working — verified leak vs. fix |
